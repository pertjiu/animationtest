...
export default function FinancialWrapped() {
  ...
  const screens: ScreenType[] = [
    ...
    },
    {
      ...
      subtitle: "Je kosten deze maand zijn €9.230. Dat is -4% lager dan vorige maand.",
      graph: "line",
      dataKey: "kosten",
      data: [
    ...
    },
    {
      ...
      subtitle: "Hoe lang je bedrijf kan blijven draaien",
      graph: "double-line",
      data: [
        ...
        <CardContent className="space-y-6 text-center p-6">
          {screen.isWelcome ? (
            <div className="flex flex-col items-center justify-center space-y-8 text-slate-800">
              ...
              <motion.div
                className="relative w-48 h-48 flex flex-col items-center justify-center border-2 border-blue-200 rounded-full"
                animate={{ rotate: 360 }}
                transition={{
                  duration: 5,
                  repeat: Infinity,
